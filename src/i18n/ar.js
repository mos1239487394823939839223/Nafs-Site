export default {
  tests: {
    openDetailsToSubmit: "افتح تفاصيل الاختبار لإدخال نتيجتك.",
    questionCount: "عدد الأسئلة",
    questionCountUnknown: "غير محدد",
    beforeYouStart: "قبل أن تبدأ",
    bookAssessmentSession: "حجز جلسة تقييم",
  },
  ...
  auth: {
    ...
    registerAsPatient: "التسجيل كمستخدم",
    registerAsDoctor: "التسجيل كمعالج",
    ...
    passwordUppercase: "حرف كبير واحد (A-Z)",
    ...
    admin: "مسؤول",
    staff: "خدمة العملاء",
    patientTitle: "انضم كمستخدم",
    patientDesc: "احجز مواعيد، واستشر المعالجين، وأدر سجلاتك الصحية",
    doctorDesc: "إدارة عيادتك ومتابعة المرضى",
    pendingApproval: "في انتظار الموافقة",
    pendingApprovalTitle: "تم تقديم الطلب بنجاح!",
    pendingApprovalDesc:
      "شكراً لتسجيلك كمعالج على منصتنا. طلبك قيد المراجعة من قبل فريق الإدارة.",
    otpTitle: "رمز التحقق",
    ...
    bookVideoConsultations: "حجز استشارات عبر الفيديو أو الصوت أو الشات أو الكتابة",
    accessMedicalRecords: "الوصول للسجلات الطبية",
    aiHealthAssistant: "مساعد صحي ذكي",
    trackHealthMetrics: "تتبع المؤشرات الصحية",
    emergencySupport: "فريق دعم متاح ٢٤ ساعة للحالات الطارئة",
    violenceBlackmailSupport: "فريق متخصص لحالات العنف والابتزاز بسرية تامة",
    adminAccessNote:
    ...
    intro: {
      ...
      emergency: {
        ...
        f3: "بروتوكول متكامل وسري للتعامل مع حالات العنف والابتزاز",
  ...
  settings: {
    ...
    arabic: "العربية",
    change: "تغيير",
      uploadPhotoDesc: "قم برفع صورة مهنية بصيغة JPG أو GIF أو PNG. الحد الأقصى 800 كيلوبايت.",
    uploadClearPhoto: "قم برفع صورة واضحة لمساعدة معالجك في التعرف عليك.",
    nameAndPhoneNumber: "الاسم ورقم الهاتف",
    consultationFee: "سعر الجلسة",
  ...
  landing: {
    ...
    hero: {
      ...
      badges: {
        ...
        certified: { title: "معالجون معتمدون", sub: "+100 معالج متخصص" },
        privacy: { title: "سرية تامة", sub: "خصوصيتك أولويتنا" },
      },
      trust: {
        privacy: "خصوصية مشفّرة",
        doctors: "معالجون معتمدون",
    ...
    services: {
      ...
      programs: {
        title: "تطوير وتوجيه",
        desc: "اكتشف أهدافك وحدد خطواتك القادمة.",
      },
    },
    doctors: {
      title: "اختر معالجك المناسب",
      viewAll: "عرض جميع المعالجين",
      bookNow: "احجز الآن",
      perSession: "للجلسة",
    },
    assessment: {
      title: "اعرف حالتك النفسية في دقائق",
      desc: "اختبار علمي بسيط يساعدك على فهم حالتك النفسية ويرشح لك المعالج المناسب.",
      cta: "ابدأ التقييم الآن",
    },
    stats: {
      users: { value: "+10K", label: "مستخدم ساعدناهم" },
      doctors: { value: "+100", label: "معالج متخصص" },
    ...
    testimonials: {
      ...
      items: [
        ...
        },
        {
          name: "منى خالد",
          role: "عميلة",
          quote: "منصة رائعة، شعرت بتفاهم حقيقي لمشكلتي. المعالجة كانت رائعة.",
        },
      ],
    },
    finalCta: {
  ...
  nav: {
    ...
    doctorWorkspace: "مساحة عمل المعالج",
  ...
  patientHome: {
    ...
    hero: {
      ...
      newPatientTitle: "ابدأ رحلتك العلاجية بخطوة واضحة",
      newPatientSubtitle: "ابدأ جلستك الأولى لتحديد البرنامج المناسب وتقييم ومتابعة حالتك النفسية",
      firstSession: "احجز جلستك الأولى",
    },
    quickActions: {
    ...
    upcomingSession: {
      ...
      loading: "جاري التحميل...",
      startNow: "ابدأ جلستك الآن",
      startNowDesc: "احجز جلستك الأولى مع معالج مختص لبدء التقييم وتحديد خطواتك القادمة",
      bookFirst: "حجز أول جلسة",
      meetingStartFailed: "تعذر بدء الجلسة.",
      directMeeting: "جلسة مباشرة",
      connectedWith: "متصل مع",
      preparingRoom: "جاري تحضير غرفة جلستك الخاصة...",
      roomReady: "غرفتك جاهزة",
      roomReadyDesc: "افتح غرفة الاجتماع الآمنة لبدء جلستك.",
      openMeeting: "فتح الجلسة",
      roomPending: "غرفة الجلسة قيد الإعداد",
      roomPendingDesc: "تم فتح الحجز، ولكن لم يتم إرسال رابط الاجتماع بعد.",
    },
    suggestedDoctors: {
      title: "معالجين مقترحون لك",
      viewAll: "عرض جميع المعالجين",
    ...
    moodGauge: {
      ...
      emptyDesc: "يضيف المعالج تقييم الحالة ومستواها والملاحظات والتوصيات بعد الجلسة الأولى.",
      awaitingTitle: "بانتظار اعتماد تقييم الحالة",
      awaitingDesc: "سيظهر تقييم حالتك وملاحظات المعالج وتوصياته هنا بعد اعتمادها.",
      bookFirst: "ابدأ جلستك الأولى",
      assessment: "التقييم النفسي",
      level: "مستوى الحالة",
      notes: "ملاحظات المعالج",
    ...
    treatmentProgram: {
      ...
      awaitingDesc: "سيظهر برنامجك العلاجي هنا فور تحديده واعتماده من المعالج.",
      bookFirst: "ابدأ جلستك الأولى",
      ...
      therapist: "المعالج",
      lastTherapistUpdate: "آخر تحديث من المعالج",
    },
    journeyUpdate: {
  ...
  patient: {
    ...
    availableDoctors: "المعالجون المتاحون",
    ...
    backToDoctors: "العودة للمعالجين",
    ...
    noDoctorsFound: "لم يتم العثور على معالجين.",
    experienceBio: "الخبرة/النبذة",
    bookingWith: "حجز مع المعالج",
    noSlotsAvailable: "لا توجد مواعيد متاحة لهذا الأسبوع",
    trySlotsNextWeek:
      "حاول الانتقال للأسبوع القادم، أو ربما المعالج لم يحدد جدوله بعد.",
    ...
    scheduleSession: "حدد جلسة مع معالج",
    ...
    doctorNote: "ملاحظة المعالج",
    doctor: "المعالج",
    testType: "نوع الاختبار",
    examNotes: "ملاحظات الفحص",
    doctorNotes: "ملاحظات المعالج",
    result: "النتيجة",
    scanUrl: "رابط المسح",
    recordId: "معرف السجل",
    bookingId: "معرف الحجز",
    noHistoryFound: "لم يتم العثور على سجل طبي",
    allDoctors: "جميع المعالجين",
    emergency: "طارئ",
    emergencyDesc: "احصل على دعم فوري",
    emergencyDashboardDesc: "ابدأ محادثة عاجلة وعالية الأولوية مع فريق الدعم.",
    startEmergencyChat: "طوارئ",
    filterDoctors: "تصفية المعالجين",
    filterPanelHint: "اختر ما يهمك للوصول إلى المعالج الأنسب",
    sortBy: "ترتيب حسب",
    sortHint: "رتّب النتائج بالطريقة المناسبة لك",
    sortDefault: "افتراضي",
    ...
    availabilityNow: "متاح الآن",
    sessionWith: "جلسة مع",
    healthJourneyDesc: "السجل الزمني لتاريخك الطبي",
    noEventsYet: "لا توجد أحداث بعد",
    aiWelcome: "مرحباً! أنا مساعدك الصحي الذكي. كيف يمكنني مساعدتك اليوم؟",
    aiSimulateRec: "أتفهم قلقك. بناءً على أعراضك، أوصي بحجز جلسة مع معالج. هل تريد مني مساعدتك في حجز موعد؟",
    alwaysHereToHelp: "دائماً هنا لمساعدتك",
    typeMessage: "اكتب رسالتك...",
    patient: "المريض",
    description: "الوصف",
    results: "النتائج",
    videoConsultation: "فيديو",
    audioConsultation: "صوت",
    writtenConsultation: "محادثة",
    reviews: "تقييم",
  ...
  doctor: {
    ...
    addClinicalRecordFor: "إضافة سجل طبي لـ",
    testType: "نوع الاختبار",
    noTestTypesAvailable: "لا توجد أنواع اختبارات متاحة",
    createTestType: "إنشاء",
    treatmentProgram: "البرنامج العلاجي",
    noProgramOption: "بدون تحديد برنامج",
    customProgramOption: "برنامج مخصص آخر",
    customProgramName: "اسم البرنامج المخصص",
    enterProgramName: "أدخل اسم البرنامج",
    programSessionsTotal: "عدد الجلسات الإجمالي",
    assessmentSummary: "تشخيص الحالة",
    assessmentSummaryPlaceholder: "مثال: اضطراب القلق العام",
    severityLevel: "مستوى الشدة",
    selectSeverityLevel: "اختر مستوى الشدة",
    severityMild: "خفيف",
    severityModerate: "متوسط",
    severitySevere: "شديد",
    severityUrgent: "عاجل",
    therapistRecommendations: "التوصيات العلاجية",
    recommendationsPlaceholder: "اكتب التوصيات والتمارين والمهام المنزلية...",
    sessionSummaryPlaceholder: "صف أبرز نقاط الجلسة وتقدم المريض وغيرها...",
    medicationsPlaceholder: "مثال: أسبرين، إيبوبروفين",
    anxietyProgram: "برنامج إدارة القلق",
    depressionProgram: "برنامج علاج الاكتئاب",
    stressProgram: "برنامج التخلص من التوتر",
    selfEsteemProgram: "برنامج تعزيز الثقة بالنفس",
    angerProgram: "برنامج التحكم في الغضب",
    cbtProgram: "برنامج الدعم السلوكي المعرفي",
    ...
    dashboardHome: {
      hero: {
        ...
        imageAlt: "معالج يعمل على حاسوبه",
      },
      tiles: {
        schedule: {
          title: "الجدول اليومي",
      ...
      dailyAgenda: "جدول اليوم",
    appointments: "المواعيد",
    availableSlots: "المواعيد المتاحة",
    viewProfile: "عرض الملف الشخصي",
    joinNow: "انضمام",
    noPatientsFoundFilter: "لا يوجد مرضى يطابقون هذا الفلتر.",
  ...
  admin: {
    ...
    activeDoctors: "المعالجون النشطون",
    patientRetention: "الاحتفاظ بالمرضى",
    totalRevenue: "إجمالي الإيرادات",
    topDoctors: "أفضل المعالجين أداءً",
    ...
    createDoctorAccount: "إنشاء حساب معالج",
    ...
    doctorName: "اسم المعالج",
    doctorEmail: "البريد الإلكتروني للمعالج",
    doctorPassword: "كلمة مرور المعالج",
    doctorPhone: "هاتف المعالج",
    doctorSpecialty: "التخصص",
    doctorDescription: "الوصف (النبذة)",
    addDoctorBtn: "+ إضافة معالج",
    cancelAdd: "إلغاء",
    ...
    noDoctorData: "لا توجد بيانات معالجين متاحة بعد",
    addNewDoctor: "إضافة معالج جديد",
    ...
    searchPatientsDocs: "البحث باسم المريض أو المعالج...",
    ...
    doctorFinanceTitle: "نظرة مالية للمعالج",
    ...
    manageBookingsDesc: "إدارة ومراقبة جميع حجوزات المنصة",
    searchPatientsDocs: "بحث باسم المريض أو المعالج...",
    allPayments: "كل الدفعات",
    noBookingsYet: "لا توجد حجوزات بعد",
    tryChangingFilters: "حاول تعديل عوامل التصفية",
    totalSessions: "إجمالي الجلسات",
    activeDoctors: "المعالجون النشطون",
    activeBookings: "الحجوزات النشطة",
    totalUsers: "إجمالي المستخدمين",
    topDoctors: "أفضل المعالجين",
    sessions: "الجلسات",
    noDoctorData: "لا توجد بيانات معالجين",
    recentBookings: "أحدث الحجوزات",
    doctorFinanceTitle: "نظرة عامة على مالية المعالج",
    totalConfirmed: "إجمالي المؤكد",
    totalPending: "إجمالي المعلق",
    totalPayedOut: "إجمالي المدفوع",
    remainingBalance: "الرصيد المتبقي",
    createPayout: "إنشاء دفعة",
    payoutAmount: "المبلغ",
    payoutHistory: "سجل الدفعات",
    ...
    supportAgentDesc: "يتعامل مع طلبات وتذاكر دعم المرضى.",
    manager: "مدير",
    managerDesc: "يشرف على عمليات المنصة والموظفين.",
    addStaff: "إضافة موظف",
    basicInfoStep: "المعلومات الأساسية",
    permissionsStep: "الصلاحيات",
    phoneOptional: "رقم الهاتف (اختياري)",
    permissionLevel: "مستوى الصلاحية",
    bullyingSpecialist: "متخصص ابتزاز/إساءة",
    bullyingSpecialistDesc: "يتعامل مع حالات الابتزاز والإساءة الحساسة.",
    bullyingSpecialistColumn: "متخصص ابتزاز/إساءة",
    bullyingSpecialistYes: "متخصص",
    bullyingSpecialistNo: "غير متخصص",
    registerStaffMember: "تسجيل موظف",
    registering: "جاري التسجيل...",
    currentStaffMembers: "الموظفون الحاليون",
    registerTeamMembers: "سجل أعضاء فريق جدد لمنصتك.",
    ...
    noDoctorsFound: "لا يوجد معالجون",
    finance: "المالية",
    noUsersFound: "لا يوجد مستخدمون",
    users: "المستخدمون",
    blackmailSupportRouting: "توجيه حالات الابتزاز / الإساءة",
    blackmailSupportRoutingDesc: "اختر حساب الدعم المخصص لاستقبال البلاغات الحساسة عالية الأولوية.",
    noSupportStaffFound: "لا يوجد موظفو دعم",
    adminRole: "مدير النظام",
    closedCases: "الحالات المغلقة",
    addNewDoctor: "إضافة معالج جديد",
    minChars: "أقل عدد للأحرف",
    professionalBio: "السيرة المهنية",
    creating: "جاري الإنشاء...",
    createDoctorAccount: "إنشاء حساب معالج",
    userDetails: "تفاصيل المستخدم وملخص خاص بالدور.",
    roleBasedEditNotice: "يمكن تعديل الحقول المسموح بها لهذا الدور فقط.",
  ...
  chat: {
    ...
    talkToDoctors: "تحدث مع المعالجين",
    talkToSupport: "تحدث مع الدعم",
    ...
    caseTypeRequired: "اختر نوع طلب الدعم قبل بدء المحادثة أو إرسال الرسالة الأولى.",
    required: "مطلوب",
    startConversation: "ابدأ المحادثة",
    startConversationDesc: "أرسل رسالتك الأولى وسيقوم الفريق بالرد عليك هنا.",
    ...
    startMeeting: "بدء الجلسة",
    callingNotSupported: "المكالمات الصوتية قريباً.",
    call: "اتصال",
    viewProfile: "عرض الملف الشخصي",
    activeConsultations: "الاستشارات النشطة",
    noConversationsFound: "لا توجد محادثات",
    tryDifferentSearch: "جرب كلمة بحث مختلفة",
    failedToStartDirectMessage: "تعذر بدء هذه المحادثة.",
    startMessage: "بدء رسالة",
    startMessageDesc: "ابحث عن مستخدم وابدأ محادثة مباشرة.",
    ...
    statusClosed: "مغلق",
    statusActive: "نشط",
    technicalTeam: "الدعم التقني",
    newConversation: "محادثة",
    noLinkedBooking: "لا يوجد حجز نشط مرتبط بهذه المحادثة.",
    ticketValidation: "أضف عنواناً قصيراً ووصفاً لا يقل عن 10 أحرف.",
    ticketCreated: "تم إنشاء تذكرة الدعم بنجاح.",
    ticketCreateFailed: "تعذر إنشاء تذكرة الدعم. حاول مرة أخرى.",
    noResults: "لا توجد نتائج",
    noSupportCasesDesc: "اختر نوع الحالة أعلاه لإنشاء ومتابعة طلب دعم.",
    noTherapistChatsDesc: "ستظهر محادثاتك مع المعالج هنا عندما تصبح متاحة.",
    loadingMessages: "جاري تحميل الرسائل...",
    messagesLoadFailed: "تعذر تحميل الرسائل",
    selectConversationDesc: "اختر محادثة من القائمة الجانبية لبدء الدردشة",
    details: "التفاصيل",
    ticketInfo: "معلومات التذكرة",
    caseType: "نوع الحالة",
    priority: "الأولوية",
    sharedFiles: "الملفات المشتركة",
    noFilesYet: "لا توجد ملفات مشتركة بعد.",
    createSupportTicket: "إنشاء تذكرة دعم",
    ticketIntro: "اشرح المشكلة بوضوح حتى يتمكن الفريق المناسب من مساعدتك بشكل أسرع.",
    ticketTitle: "عنوان مختصر للمشكلة",
    ticketTitlePlaceholder: "مثال: لا يمكنني الانضمام إلى جلستي",
    ticketDescription: "الوصف",
    ticketDescriptionPlaceholder: "أخبرنا بما حدث وما تحتاج المساعدة فيه...",
    attachFiles: "إرفاق ملفات",
    filesSelected: "ملف محدد",
    attachFilesHint: "صور أو PDF أو مستندات",
  ...
  staff: {
    ...
    hubSubtitle: "الجسر بين المرضى والمعالجين والدعم",
    online: "متصل",
    ...
    doctorSupportQueue: "قائمة دعم المعالجين",
  ...
  errors: {
    ...
    failedLoadDoctors: "فشل تحميل قائمة المعالجين",
    failedLoadBookings: "فشل تحميل الحجوزات",
    failedSendMessage: "فشل إرسال الرسالة",
    failedCancelAppointment: "فشل إلغاء الموعد",
      invalidAmount: "يرجى إدخال مبلغ دفع صالح",
    imageUploadFailed: "تم إنشاء المعالج، لكن فشل رفع الصورة",
    enterSummary: "يرجى إدخال ملخص",
    saveFailed: "فشل الحفظ",
    selectDate: "يرجى اختيار تاريخ",
    deleteFailed: "فشل الحذف",
    loadDoctorsFailed: "فشل تحميل المعالجين",
    loadBookingsFailed: "فشل تحميل الحجوزات",
    doctorNotFound: "المعالج غير موجود",
    cancelFailed: "فشل الإلغاء",
    bookingFailed: "فشل الحجز",
    photoUpdateFailed: "فشل تحديث الصورة",
  ...
  success: {
    ...
    doctorAdded: "تم إضافة المعالج بنجاح",
    ...
    slotAdded: "تمت إضافة الموعد بنجاح",
    timeBlocked: "تم حظر الوقت بنجاح",
  ...
  blogs: {
    ...
    pendingArticles: "مقالات قيد المراجعة",
    categories: "التصنيفات/الوسوم",
    allStatuses: "كل الحالات",
  ...
  auto: {
    ...
    createTestsAndTagsThenMonitorAllDoctorAndPatientResultsInOnePlace:
      "أنشئ الاختبارات والوسوم وتابع نتائج المرضى والمعالجين في مكان واحد.",
    ...
    cancelledByDoctor: "تم الإلغاء بواسطة المعالج",
    ...
    articlesAndGuidesFromSupportTeamDoctors:
      "مقالات ودلائل من فريق الدعم والمعالجين",
    ...
    theSelectedSlotWasCancelledByTheDoctorPleaseChooseAnotherSlot:
      "تم إلغاء الموعد المحدد من المعالج. اختر موعدًا آخر.",
    ...
    doctorReviews: "تقييمات المعالج",
    addYourReview: "أضف تقييمك",
    shareYourExperienceWithThisDoctor: "اكتب تجربتك مع المعالج...",
    ...
    lgorder2: "lg:order-1",
    lgorder1: "lg:order-2",
    drSarahAhmed: "المعالجة سارة أحمد",
    anxietyDepression: "القلق والاكتئاب",
    drMohammedAli: "المعالج محمد علي",
    familyTherapy: "العلاج الأسري",
    drLaylaHassan: "المعالجة ليلى حسن",
    cognitiveTherapy: "العلاج المعرفي",
    drKarimMansour: "المعالج كريم منصور",
    ...
    failedToOpenSupportChat: "تعذر فتح محادثة الدعم الفني",
      testPurpose: "الغرض من الاختبار",
    testPurposeFallback: "فهم احتياجاتك الحالية ودعم الخطوة القادمة.",
    testDuration: "المدة",
    durationVaries: "تختلف حسب الاختبار",
    price: "السعر",
    howToStart: "كيفية البدء",
    reviewTestDetails: "راجع تفاصيل الاختبار.",
    openAndCompleteTest: "افتح الاختبار وأكمله.",
    returnAndSubmitResult: "عد وأدخل نتيجتك.",
    startTest: "بدء الاختبار",
    viewTestDetails: "عرض تفاصيل الاختبار",
