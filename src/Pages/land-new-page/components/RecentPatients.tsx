...
export const RecentPatients = ({ patients = [], loading = false }: RecentPatientsProps) => {
  ...
  return (
    <section className="rounded-3xl bg-card border border-border shadow-card p-6 md:p-7">
      ...
      {loading && (
        <div className="flex flex-col gap-2">
          {[1, 2, 3].map((n) => (
            <div key={n} className="grid grid-cols-[1fr_auto_auto_auto] items-center gap-4 p-3 rounded-2xl animate-pulse">
