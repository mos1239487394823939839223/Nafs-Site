  ...
  return (
    <section className="relative overflow-hidden rounded-[24px] border border-[#E5E7EB] bg-white p-6 shadow-[0_14px_40px_rgba(15,81,50,0.06)]">
      ...
      <div className="relative">
        <p className="mb-3 text-start text-sm font-bold text-[#60766C]">{t("patientHome.treatmentProgram.label")}</p>

        {loading ? (
          <Loader2 className="mx-auto my-14 h-7 w-7 animate-spin text-[#2F855A]" />
        ) : (
          <>
            <h3 className="mb-5 text-start text-2xl font-black text-[#12372A]" dir="auto">
              {programName}
            </h3>
            ...
            <p className="mt-4 text-start text-sm leading-6 text-[#60766C]">
