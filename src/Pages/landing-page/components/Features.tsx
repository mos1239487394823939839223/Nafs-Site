...
const Features = () => {
  return (
    <section className="px-6 lg:px-10 py-20 bg-gradient-soft">
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-14">
          <h2 className="font-display text-3xl md:text-5xl font-extrabold">كل ما تحتاجه في مكان واحد</h2>
        </div>

        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
          {features.map(({ icon: Icon, title, desc }) => (
            <div key={title} className="bg-card rounded-3xl p-7 border border-border/60 shadow-card hover:shadow-soft transition-all hover:-translate-y-1">
