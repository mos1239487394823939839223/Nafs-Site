...
const quick = ["الرئيسية", "الخدمات", "الدكاترة", "المقالات"];
const support = ["الأسئلة الشائعة", "سياسة الخصوصية", "الشروط والأحكام", "تواصل معنا"];
...
export const Footer = () => (
  <footer className="bg-cream-deep">
    <div className="container mx-auto grid gap-10 px-4 py-12 md:grid-cols-4">
      {/* Contact */}
      <div className="text-right">
        <h4 className="mb-4 text-base font-bold text-foreground">تواصل معنا</h4>
        <ul className="space-y-3 text-sm text-muted-foreground">
          <li className="flex items-center justify-end gap-2">
      ...
      {/* Support */}
      <div className="text-right">
        <h4 className="mb-4 text-base font-bold text-foreground">الدعم والمساعدة</h4>
        <ul className="space-y-2 text-sm text-muted-foreground">
          {support.map((s) => (
            <li key={s}><a href="#" className="hover:text-brand">{s}</a></li>
          ))}
        </ul>
      </div>
      {/* Quick links */}
      <div className="text-right">
        <h4 className="mb-4 text-base font-bold text-foreground">روابط سريعة</h4>
        <ul className="space-y-2 text-sm text-muted-foreground">
          {quick.map((s) => (
            <li key={s}><a href="#" className="hover:text-brand">{s}</a></li>
          ))}
      ...
      <div className="text-right">
        <Logo />
        <p className="mt-4 text-sm leading-relaxed text-muted-foreground">
          نفس، منصة دعم نفسي سرية تساعدك على فهم نفسك والتحدث مع متخصصين متى احتجت.
        </p>
        <div className="mt-4 flex items-center gap-3 justify-end">
          <a href="#" aria-label="Instagram" className="text-muted-foreground hover:text-brand"><IconInstagram /></a>
          <a href="#" aria-label="Twitter" className="text-muted-foreground hover:text-brand"><IconTwitterX /></a>
